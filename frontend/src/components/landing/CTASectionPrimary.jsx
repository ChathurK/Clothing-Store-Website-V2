...
const CTASectionPrimary = () => {
  ...
  return (
    <section
      id="cta-primary"
      className="flex h-[calc(50vh-32px)] items-center bg-white py-16 sm:h-[25vh] md:py-20 lg:h-auto lg:py-16 xl:h-[268px] dark:bg-black"
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col px-4 md:items-center">
        {/* Quote */}
        <h2 className="text-black-700 dark:text-black-300 mb-8 text-3xl font-medium text-balance md:text-4xl lg:text-5xl">
          Don't wear to{" "}
        ...
        <div className="group relative w-fit">
          <button
            ...
            className="relative z-10 inline-block cursor-pointer px-8 py-3 text-base font-semibold text-white inset-ring inset-ring-black transition-colors duration-300 hover:text-black active:text-black md:px-10 md:py-4 md:text-lg dark:text-black dark:inset-ring-white dark:hover:text-white dark:active:text-white"
          >
            Shop Now
          </button>
