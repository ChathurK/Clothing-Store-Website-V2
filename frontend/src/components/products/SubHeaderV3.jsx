...
const SubHeader3 = ({
  ...
  return (
    <div
      className={`sticky ${headerVisible ? "top-16 duration-500 sm:top-12" : "top-0 duration-300"} dark:border-b-black-300 z-40 bg-white/60 backdrop-blur-xs transition-all dark:bg-black/60`}
    >
      <div className="flex h-16 items-center justify-between sm:h-12">
        ...
        <div className="flex h-full items-center gap-2">
          ...
          <button
            ...
            className="group dark:border-black-300 relative flex h-full w-16 cursor-pointer items-center justify-center gap-2 px-3 transition-colors duration-300 hover:bg-black active:bg-black sm:w-12 dark:hover:bg-white dark:active:bg-white"
        ...
        <motion.div
          layout
          className="hidden h-full bg-black p-1 sm:flex dark:bg-white"
        >
            ...
            return (
              <button
                ...
                className={`group relative cursor-pointer p-2.5 text-sm font-medium transition-colors ${
                  isActive
                    ? "text-black duration-500 dark:text-white"
                    : "text-zinc-400 hover:bg-zinc-800 dark:text-gray-700 dark:hover:bg-gray-100"
                }`}
              >
                {isActive && (
                  <motion.span
